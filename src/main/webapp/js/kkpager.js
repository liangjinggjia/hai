...
var kkpager = {
    ...
    gopage: function (data) {
        ...
        if(data.tagName == 'A') {
            ...
            if (isNaN(str_page)||str_page=="") {
                $("#btn_go_input").val(kkpager.pno);
                return false;
            }
            ...
            if( n > this.total){
                $("#btn_go_input").val(kkpager.total);
                currentPage=kkpager.total;
            }

        }
        buildTable(conditon,currentPage,this.pagesize);
    ...
    changepageSize:function(data){
        ...
        buildTable(conditon,1,pageSize);
    },
    //分页按钮控件初始化
